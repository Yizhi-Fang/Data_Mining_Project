...
5.  Find topics in Methods with K-Means clustering and display topic words with Word Cloud;
6.  Determine Method/Problem by 2-nearest neighbor words with Logistic SVM with SGD training.
